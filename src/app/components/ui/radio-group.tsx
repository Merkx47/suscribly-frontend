...
function RadioGroupItem({
  ...
  return (
    <RadioGroupPrimitive.Item
      ...
      className={cn(
        "border-gray-300 text-purple-600 focus-visible:border-purple-500 focus-visible:ring-purple-500/20 aria-invalid:ring-destructive/20 aria-invalid:border-destructive aspect-square size-4 shrink-0 rounded-full border-2 shadow-sm transition-colors outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:border-purple-600 data-[state=checked]:bg-purple-600",
        className,
      )}
      {...props}
    >
